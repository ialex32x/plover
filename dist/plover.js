    ...
    class BuiltinIcons {
        static getIcon(name) {
            ...
            if (typeof icon === "undefined") {
                icon = this._cache[name] = UnityEditor_8.AssetDatabase.LoadAssetAtPath(`Assets/jsb/Editor/Icons/${name}.png`, UnityEngine_10.Texture);
            }
            return icon;
        }
    }
    ...
    class EdCache {
        static T(title, tooltip = null, image = null) {
            ...
            if (typeof item === "undefined") {
                item = this.cache[title] = tooltip == null ? new UnityEngine_14.GUIContent(title, image) : new UnityEngine_14.GUIContent(title, image, tooltip);
            }
            return item;
        }
    }
